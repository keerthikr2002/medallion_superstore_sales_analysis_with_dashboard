# Enterprise Sales Intelligence & Medallion Analytics
...
This project presents a full-cycle Data Engineering and Business Intelligence solution built to analyze global automobile and clothing sales performance. The goal was to design a scalable, production-style data pipeline that transforms raw, siloed CSV data into a clean, queryable warehouse — and finally into an executive-ready Power BI dashboard (`Executive_Sales_Performance_Dashboard.pbix`).

The core challenge this project solves: **raw sales data across multiple domains (products, customers, geography) was unstructured and unusable for business decisions.** By implementing a multi-stage Medallion Architecture in MS SQL Server, I ensured data integrity at every stage — from ingestion to final visualization — providing stakeholders with a reliable "Single Source of Truth."

---

### 📊 Executive Dashboard Insights

The Power BI dashboard features a highly interactive, unified application layout across 6 core tabs. Dynamic parameter fields switch the entire page context to evaluate performance across six strategic vectors: Sales, Cost, Profit, Customers, Orders, and Quantity.

| `Screenshot 2026-06-14 172226.png` | `Screenshot 2026-06-14 172244.png` | `Screenshot 2026-06-14 172305.png` |
|:---:|:---:|:---:|
| ![Profit Tab](Reports/Screenshot_2026-06-14_172226.png) | ![Cost Tab](Reports/Screenshot_2026-06-14_172244.png) | ![Sales Tab](Reports/Screenshot_2026-06-14_172305.png) |
| **Profit Performance Tab** | **Cost Performance Tab** | **Sales Performance Tab** |

| `Screenshot 2026-06-14 172413.png` | `Screenshot 2026-06-14 172437.png` | `Screenshot 2026-06-14 172505.png` |
|:---:|:---:|:---:|
| ![Customers Tab](Reports/Screenshot_2026-06-14_172413.png) | ![Orders Tab](Reports/Screenshot_2026-06-14_172437.png) | ![Quantity Tab](Reports/Screenshot_2026-06-14_172505.png) |
| **Customers Performance Tab** | **Orders Performance Tab** | **Quantity Performance Tab** |
...
| Layer | Purpose | Key Data Analyst & Engineering Transformation Focus |
| :--- | :--- | :--- |
| **Bronze (Raw)** | Initial Ingestion | Initial ingestion of source CSVs (Sales, Products, Customers, Geography) with no transformation. Secure landing zone. |
| **Silver (Cleansed)** | Cleanse & Enrich | Applying business logic, deduplication, schema enforcement, data type standardization, and handling null values securely (such as utilizing `COALESCE(Score, 0)` variations to prevent calculation errors in downstream aggregations). |
| **Gold (Curated)** | Business Modeling | Star Schema modeling with explicit Fact tables (Sales Transactions) and Dimension tables (Customers, Products, Time) optimized with clean relationships for direct, high-performance Power BI extraction. |
...
| **Power BI** | Dashboard visualization and DAX engineering |
...
│   ├── Screenshot 2026-06-14 172244.png
│   ├── Screenshot 2026-06-14 172305.png
│   ├── Screenshot 2026-06-14 172413.png
│   ├── Screenshot 2026-06-14 172437.png
│   └── Screenshot 2026-06-14 172505.png
...
* Translating technical multi-tab metric profiles into an organized executive performance summary to support strategic data decisions.
